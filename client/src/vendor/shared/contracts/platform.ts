...
export const FEATURE_MODELS: FeatureModelDef[] = [
  ...
  {
    id: 'smart_diff',
    label: 'Smart Diff · Summaries',
    description: 'Writes the "what this does" pseudocode summary for a changed file.',
    defaultProvider: 'openrouter',
    defaultModel: 'deepseek/deepseek-v4-flash',
  },
];
...
export const PrMeta = z.object({
  ...
  // Total USD cost of ALL the PR's runs — every agent, every re-run (list
  // endpoint only; null/absent when no run reported a cost).
